    ...
    <div class="bc-head-txt-label bc-head-icon-chrome_android"><?php echo $student['unique_key']; ?></div>
        <div class="header d-flex justify-content-between">
            ...
            <div style="display: flex; justify-content: end; flex-direction: column; align-items: end;">
                <img src="images/logo.png" alt="" class="img-fluid" width="180px" style="float: right;">
            </div>
        </div>
        ...
        <div style="margin-top: 30px;">
            <div class="first-row">
                <p style="font-size: 14px;"><span style="font-weight: bolder;">FULLNAME:</span> SHAHMIR AHSANULLAH SHAHMIR BALOCH</p>
            </div>
            <div class="second-row" style="margin-top: 10px; display: flex;">
                <p style="font-size: 14px; margin-right: 10px;"><span style="font-weight: bolder;">CNIC / PASSPORT #:</span> 42201-1805406-5</p>
                <p style="font-size: 14px;"><span style="font-weight: bolder;">GENDER:</span> FEMALE</p>
            </div>
            <div class="third-row" style="margin-top: 10px; display: flex;">
                <p style="font-size: 14px; margin-right: 10px;"><span style="font-weight: bolder;">DOB:</span> 20 FEB 1990</p>
                <p style="font-size: 14px;"><span style="font-weight: bolder;">CITY:</span> NAWABSHA BALOCHISTAN</p>
            </div>
            <div class="fourth-row" style="margin-top: 5px;">
                <p style="font-size: 14px; line-height: 20px;"><span style="font-weight: bolder;">RESIDENTIAL ADDRESS:</span> AHSANULLAH HOUSE 145/A BLOCK B SMCHS, KARACHI, PAKISTAN</p>
            </div>
        </div>
        ...
        <div class="redeeming" style="margin-top: 7px;">
            <p style="font-size: 20px; text-align: center; font-weight: 600; color: #dc1335;">Redeem Before March 31, 2025!</p>
        </div>
        <div class="terms&condition" style="margin-top: 20px; line-height: 20px;">
            ...
            <p style="font-size: 12px;">1. This amount must be redeemed before it expires on March 31, 2025; after expiry, it cannot be used</p>
